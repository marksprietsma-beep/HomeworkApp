...
| `pseudocodeDialect` | No | string/null | Optional for pseudocode questions; currently supports `CAMBRIDGE_9618_2026`. Existing JSON can omit it. |
...
12. Question `type` must be one of `OPEN_TEXT` or `MULTIPLE_CHOICE`. Optional question `responseMode` must be `TEXT` or `PSEUDOCODE` when present. Optional `pseudocodeDialect` must be `CAMBRIDGE_9618_2026` when present.
...
## Cambridge 9618 pseudocode fixture

<!-- fixture: docs/fixtures/assignment-import/valid/pseudocode-loops.json -->
```json
{
  "formatVersion": "assignment-import-v1",
  "assignment": {
    ...
    "questions": [
      {
        ...
        "order": 1,
        "type": "OPEN_TEXT",
        "prompt": "Write pseudocode that inputs 10 test scores and outputs their total.",
        "points": 5,
        "responseMode": "PSEUDOCODE",
        "pseudocodeDialect": "CAMBRIDGE_9618_2026"
      },
      {
        ...
        "order": 2,
        "type": "OPEN_TEXT",
        "prompt": "Complete a WHILE loop that repeatedly inputs values until -1 is entered, then outputs the count of values entered.",
        "points": 6,
        "responseMode": "PSEUDOCODE",
        "pseudocodeDialect": "CAMBRIDGE_9618_2026"
      }
