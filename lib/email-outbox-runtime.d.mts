...
export function processEmailOutbox(options: { db: any; limit?: number; ids?: number[]; manual?: boolean; transport?: EmailTransport; now?: Date }): Promise<{ processed: number; sent: number; failed: number; skipped: number; message: string }>;
