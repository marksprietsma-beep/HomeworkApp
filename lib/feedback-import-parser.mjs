...
function validateQuestionFeedback(value, path, errors, context, exportedParticipant, seenActionIds) {
  ...
  return value.map((question, index) => {
    ...
    addUnknownFieldErrors(errors, questionPath, question, new Set(["questionId", "questionOrder", "feedback", "feedbackI18n", "strengths", "strengthsI18n", "targets", "targetsI18n", "teacherNotes", "followUpActions"]));
