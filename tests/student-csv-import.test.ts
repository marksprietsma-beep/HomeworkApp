...
test("temporary passwords are human-shareable and derived from supplied random bytes", () => {
  assert.equal(generateTemporaryPassword(Buffer.alloc(18, 1)), "AQEBAQ-EBAQEB-AQEBAQ-EBAQEB");
});
