      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {assignment.leaderboardEnabled ? <Link href={`/classes/${assignment.classId}/leaderboard`} className="inline-flex rounded-full border border-cyan-200 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-900 shadow-sm">Class leaderboard</Link> : null}
            <Link
    ...
    <section className="mt-10 w-full rounded-3xl border border-slate-200 bg-white/80 p-6 text-left shadow-sm sm:p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <Link href="/profile" className="mt-4 inline-flex rounded-full bg-cyan-100 px-4 py-2 text-sm font-semibold text-cyan-950 hover:bg-cyan-200">Profile &amp; appearance</Link>
        </div>
