...
export default async function FirstRunSetupPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center px-6 py-16">
      ...
      <p className="mt-4 text-base leading-7 text-slate-600">This clean-start database has no ADMIN user yet. Create exactly one initial admin account before adding teachers, students, classes, assignments, submissions, or feedback.</p>
