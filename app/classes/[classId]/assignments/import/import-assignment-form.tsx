...
- Use OPEN_TEXT for any written answer, including longer explanation or evaluation questions. Add optional responseMode: "PSEUDOCODE" for coding, declaration, record, enum, pointer, or pseudocode responses; omit responseMode or use "TEXT" otherwise.
