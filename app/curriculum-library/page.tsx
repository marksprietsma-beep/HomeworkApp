  ...
  return (
    <main className="mx-auto min-h-screen max-w-6xl px-6 py-12">
      ...
      <section className="mt-8 rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm sm:p-8">
        ...
        {!canUseLibrary ? <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">You must be signed in as a teacher or ADMIN account to browse and assign curriculum library items.</div> : null}
